...
/**
 * Code Assistant Agent Document Template
 * Specializes in code review, refactoring, test generation, and debugging
 */
 ...
 * @deprecated Use codeAssistantDocumentTemplate instead
 */
