import type { DocumentSection } from '../template-types.js';

/**
 * Standardized section names for all document templates
 */
...
/**
 * Standardized section templates for all document templates
 */
